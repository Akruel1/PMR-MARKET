    ...
    <>
      ...
      {showModal && (
        ...
        >
          ...
          >
            <h3 className="text-lg sm:text-xl font-bold text-dark-text mb-4">Пожаловаться на объявление</h3>
            <textarea
              value={reason}
              onChange={(e) => setReason(e.target.value)}
              placeholder="Укажите причину жалобы..."
              className="w-full h-32 px-3 py-2 rounded-lg bg-dark-bg border border-neutral-700 text-sm sm:text-base text-dark-textSecondary placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-primary-500 resize-none"
            />
