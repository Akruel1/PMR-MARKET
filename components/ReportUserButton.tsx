    ...
    <>
      ...
      {showModal && (
        ...
        >
          ...
          >
            <h3 className="text-lg sm:text-xl font-bold text-dark-text mb-4">Пожаловаться на пользователя</h3>
            <p className="text-sm sm:text-base text-dark-textSecondary mb-4">"{userName}"</p>
            <textarea
              value={reason}
